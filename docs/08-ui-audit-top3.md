...
| **2 · Identifikatsiya** | qisman ✅ 2026-09-22, fotolar kelgach 2–3 kun | ✅ 5 host: palitra + wordmark `brand-map.json` da, OG-kartalar, faviconlar (`scripts/build-assets.mjs`). ✅ **2026-09-22 rasmlar bilan boyitildi**: har bir asosiy bo'limga toza (suzsiz) stock/real foto qo'yildi — `public/images/` da 15 kadr: home (Registon + uch «esik» karta), /visitors/ (Afrosiyob, samolyot, avto, otel), /exhibitors/ + /venue/ (zal, galeriya), /organizers/ (konferensiya), 5 tadbir (dasturhona, issiqlikxon, supermarket, kampus). Yangi bloklar: `grid` karta ustiga foto, `text`+foto, `callout`+foto. **Pass 2+3:** 5 tadbir × 3 subpage (RU+EN) hamda /programme/, /conferences/, /stand-construction/, /services/ ×2, /sponsorship/, /documents/, /catalogue/, /faq/, /checklist/ hero'lari — har bir muhtam sahifada rasm bor; og'irlik optimallashtirildi (~300KB); ro'yxat §5c da. ⏳ Organizator logotiplari (5 ta) → `mark: "star"` + huddi o'sha `favicon.svg`; **real fotolar 1:1 ushbu fayl nomlari bo'yicha** almashtiriladi; hamkor logotiplari; jamoa fotolari | Logotiplar (SVG/AI), 22 kadr (`docs/07 §4`), hamkor logotiplari |
