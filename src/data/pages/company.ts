  ...
  },
  {
    ...
    meta: {
      ru: {
        ...
        description:
          "Проектные директор отраслевых выставок, менеджер по продажам площади, технический директор площадки, служба регистрации и маркетинг. К кому по какому вопросу и как связаться напрямую.",
      },
      en: {
