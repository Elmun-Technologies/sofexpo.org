      ...
      ru: [
        {
          ...
          imageAlt: "Посетители между стендами в зале",
        },
        {
          type: "h2",
          kicker: "Календарь",
          ...
          items: [
            {
              ...
              image: "/images/afrosiyob-train.jpg",
              imageAlt: "Скоростной поезд Afrosiyob на платформе",
            },
            {
              icon: "plane",
              title: "Самолёт",
              text: "Аэропорт SKD: прямые рейсы из Ташкента, Стамбула, Дубая и Москвы. 20 минут до центра.",
              image: "/images/plane-window.jpg",
              imageAlt: "Вид из иллюминатора над облаками",
            },
            {
              icon: "car",
              title: "Авто",
              ...
              imageAlt: "Трасса М39 Ташкент — Самарканд",
            },
          ],
        },
        {
      ...
      en: [
        {
          ...
          image: "/images/hall-crowd.jpg",
          imageAlt: "Visitors between stands in the hall",
        },
        {
          type: "h2",
          kicker: "Calendar",
          ...
          items: [
            {
              ...
              image: "/images/afrosiyob-train.jpg",
              imageAlt: "Afrosiyob high-speed train at the platform",
            },
            {
              icon: "plane",
              title: "Plane",
              ...
              image: "/images/plane-window.jpg",
              imageAlt: "View from the aircraft window above the clouds",
            },
            {
              icon: "car",
              title: "By car",
              ...
              image: "/images/car-road.jpg",
              imageAlt: "M39 highway Tashkent — Samarkand",
            },
          ],
        },
        {
